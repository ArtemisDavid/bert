...
flags.DEFINE_string("init_checkpoint", data_root + 'bert_model.ckpt', "Initial checkpoint")
flags.DEFINE_string("bert_config_file", data_root + 'bert_config.json', "bert config")
flags.DEFINE_string("bert_vocab_file", data_root + 'vocab.txt', "BERT's vocabulary file.")
flags.DEFINE_string("bert_vocab_En_file", data_root + 'vocab.txt', "BERT's vocabulary file.")
flags.DEFINE_string("data_dir", "data/atec/", "data dir.")
flags.DEFINE_string("saved_model_dir", "weight/atec/", "d")
flags.DEFINE_string("output_dir", "output/", "Total number of training epochs to perform.")
...
def filed_based_convert_examples_to_features(
        examples, label_list, max_seq_length, tokenizer, output_file, write2file=False):
...
def train_input_fn(features, labels, batch_size):
    # input_file, seq_length, is_training,
...
class AtecProcessor(DataProcessor):
    """Processor for the Atec data set."""
    ...
    def get_all_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "all.csv")), "train")
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            predictions = {
                'pre_label': tf.argmax(logits, axis=-1, output_type=tf.int32),
...
def main(_):
    ...
    tokenizer = tokenization.CharTokenizer(vocab_file=FLAGS.bert_vocab_file)
